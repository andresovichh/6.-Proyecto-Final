...
//     console.log(last_tx)})
    .then((last_tx) =>{
        ...
        var interval = setInterval(function (){
            var start = Date.now();
            var search_time = 25000;
            
            if (Date.now() - start < search_time){
            ...
            return response.json();
                ...
                if (response.data[0].transaction_id)
                {
                    ...
                    if (response.data[0].transaction_id =="7aadcef9c6865a5d328634e500c6f124ee1e085b08095375dae5675d51fe634e")
                    {
